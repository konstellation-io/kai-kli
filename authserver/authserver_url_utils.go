...
func (as *BrowserAuthenticator) buildAuthorizationRequest(config *KeycloakConfig) string {
	return fmt.Sprintf(
...
func (as *BrowserAuthenticator) buildTokenExchangeRequest(code string, config *KeycloakConfig) (*http.Request, error) {
