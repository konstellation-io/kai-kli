...
func (_m *MockVersionClient) List(server *configuration.Server, productID string) ([]*version.Version, error) {
	...
	var r0 []*version.Version
	var r1 error
	if rf, ok := ret.Get(0).(func(*configuration.Server, string) ([]*version.Version, error)); ok {
		return rf(server, productID)
	}
	if rf, ok := ret.Get(0).(func(*configuration.Server, string) []*version.Version); ok {
...
func (_c *MockVersionClient_List_Call) Return(_a0 []*version.Version, _a1 error) *MockVersionClient_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVersionClient_List_Call) RunAndReturn(run func(*configuration.Server, string) ([]*version.Version, error)) *MockVersionClient_List_Call {
	_c.Call.Return(run)
	return _c
}
