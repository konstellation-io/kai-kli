...
func (m *MockRuntimeInterface) Create(name, description string) error {
	m.ctrl.T.Helper()
...
func (mr *MockRuntimeInterfaceMockRecorder) Create(name, description interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockRuntimeInterface)(nil).Create), name, description)
}

// List mocks base method.
func (m *MockRuntimeInterface) List() ([]runtime.Runtime, error) {
	m.ctrl.T.Helper()
