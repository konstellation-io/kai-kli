...
func (m *MockRenderer) RenderServers(kaiConfiguration *server.KaiConfiguration) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RenderServers", kaiConfiguration)
}

// RenderServers indicates an expected call of RenderServers.
func (mr *MockRendererMockRecorder) RenderServers(kaiConfiguration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RenderServers", reflect.TypeOf((*MockRenderer)(nil).RenderServers), kaiConfiguration)
}
